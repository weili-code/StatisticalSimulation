...
This project develops notes on statistical computation and simulation, covering core methods in optimization, Monte Carlo techniques, and Markov chain Monte Carlo (MCMC).

Code implementations and applied examples will be added in future updates. Feedback is welcome.
