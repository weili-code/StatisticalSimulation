...
$$
If we instead consider $\tilde{A}=\sum_{i=1}^l d_i{u}_iv_i^T$ for some $l < r$, then this is the low-rank approximation to $A$, sometimes is called **truncated SVD**.

**Note**: if $m \geq n$, sometimes **thin SVD** is written as 
\begin{align*}
