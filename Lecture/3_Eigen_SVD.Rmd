...
$$
  ...
  \begin{bmatrix}
    ...
    V_{n-r}^{T}
  \end{bmatrix}
  = U_{r}DV_{r}^{T}=\sum_{i=1}^r d_i{u}_iv_i^T.
$$
**Note 1**: If we instead consider $\tilde{A}=\sum_{i=1}^l d_i{u}_iv_i^T$ for some $l < r$, then this is the low-rank approximation to $A$, sometimes is called **truncated SVD**.
