...
\end{align*}
which states that the probability of being in state $j$ times the net total flow out of state $j$ is equal to the sum of the probability of being in every other state $i$ times the net flow from that state into $j$.
